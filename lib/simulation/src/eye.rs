...
mod tests {
    ...
    impl TestCase {
        fn run(self) {
            let eyes = Eye::new(self.fov_range, self.fov_angle, EYE_CELLS);

            let actual_vision = eyes.process_vision(
    ...
    #[test_case(0.2, "             ")]
    #[test_case(0.1, "             ")]
    fn test_fov_ranges(fov_range: f32, expected_vision: &'static str) {
        TestCase {
    ...
    #[test_case(2.25 * PI, "        +    ")]
    #[test_case(2.50 * PI, "      +      ")]
    fn test_rotations(rot: f32, expected_vision: &'static str) {
        TestCase {
    ...
    #[test_case(1.75 * PI, ".   .+ +.   .")]
    #[test_case(2.00 * PI, "+.  .+ +.  .+")]
    fn test_fov_angles(fov_angle: f32, expected_vision: &'static str) {
        TestCase {
            foods: vec![
                food!(0.0, 0.0),
                food!(0.0, 0.33),
